    ...
    *,
    ...
    phases = (
        ...
        LaunchPhase("cadence", f"Weeks 2+ — steady cadence (~{cadence}/week)",
                    ...
                    "quiet.",
                    tuple(cadence_steps)),
        LaunchPhase("ongoing", "Ongoing — the weekly habit",
